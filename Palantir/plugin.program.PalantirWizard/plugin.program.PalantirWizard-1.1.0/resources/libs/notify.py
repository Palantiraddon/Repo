...
def firstRun():
	class MyWindow(xbmcgui.WindowXMLDialog):
		def __init__(self, *args, **kwargs):
			...
			self.msg   = "Actualmente no hay Ningun Wizard Palantir instalado desde %s.\n\nSeleciona 'Wizard Menu' para instalar Wizard Palantir o 'Ignorar' para no volver a ver este mensaje.\n\nGracias por escoger %s." % (ADDONTITLE, ADDONTITLE)
